            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="service-img text-center">
                        <img src="img/affiliate-marketing/img-1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pt-30" style="background-color:">
        <div class="container">
            ...
            <div class="row align-items-center pb-80" style="margin-bottom:35px;">
                ...
                <div class="col-lg-6">
                    <div class="text-center" data-animate="fadeInUp" data-delay=".1">
                        <img src="img/affiliate-marketing/img-3.jpg" alt="" data-rjs="2">
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="cl-md-12">
                    <div class="section-title text-center" style="padding-left: 50px;padding-right: 50px;">
                        <h2 style="color:#fff;font-size:44px;">Why choose us?</h2>
