            ...
            <div class="col-md-12 text-center">
                <div class="img-wrap-services" style="background-image: url('img/bg/bg-3.jpg');">
                    <div class="heading-title">
                        <h4 style=""><strong>Domain Registration</strong></h4>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="pt-50 pb-50">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="service-img text-center">
                        <img src="img/domain-registering/img-2.jpg" alt="">
                    </div>
                </div>
            </div>
    ...
    <section class="pt-50 pb-50">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="service-img text-center">
                        <img src="img/domain-registering/img-3.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="service-details">
                        <p>
                            Once you have got provided your registrar with these data, they'll then start the domain name registration method for you. The registrar can send your domain name request, and therefore the contact and technical data of the name to the written account. The written account conjointly adds your domain zone files to the main servers. These main servers tell alternative servers on the web wherever your site is kept.
                        </p>
