            ...
            <div class="col-md-12 text-center">
                <div class="img-wrap-services" style="background-image: url('img/bg/bg-3.jpg');">
                    <div class="heading-title">
                        <h4 style=""><strong>Email Marketing</strong></h4>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-img text-center">
                        <img src="img/email-marketing.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pt-50 pb-50">
        <div class="container">
            ...
            <div class="row align-items-center pb-80">
                <div class="col-lg-6">
                    <div class="number-one-content" data-animate="fadeInUp" data-delay=".5">
                        <h4 style="font-size: 32px;line-height: 1.2;margin-bottom: 10px;">Track Campaigns. Monitor Reports</h4>
                        <p>
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="text-center" data-animate="fadeInUp" data-delay=".1">
                        <img src="img/MangagedMonitoringConsole.png" alt="" data-rjs="2">
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-3 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".1">
                        ...
                        <div class="single-feature-content mt-50">
                            <h1>5 year</h1>
                            <h4 style="font-weight:normal;color:#777;" class="mt-30">SINCE <br>WE LAUNCHED</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".4">
                        ...
                        <div class="single-feature-content mt-50">
                            <h1>500</h1>
                            <h4 style="font-weight:normal;color:#777;" class="mt-30">SATISFIED <br>CUSTOMERS</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".7">
                        ...
                        <div class="single-feature-content mt-50">
                            <h1>13 million</h1>
                            <h4 style="font-weight:normal;color:#777;" class="mt-30">EMAILS <br>SENT/MONTH</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-feature single-feature-img-top text-center" data-animate="fadeInUp" data-delay=".7">
                        ...
                        <div class="single-feature-content mt-50">
                            <h1>80</h1>
                            <h4 style="font-weight:normal;color:#777;" class="mt-30">DESIGNED <br>TEMPLATES</h4>
                        </div>
                    </div>
                </div>
            </div>
