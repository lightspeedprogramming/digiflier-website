...
?>
            ...
            <div class="col-md-12 text-center">
                <div class="img-wrap-services" style="background-image: url('img/bg/bg-3.jpg');">
                    <div class="heading-title">
                        <h4 style=""><strong>Search Engine Optimization</strong></h4>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p>
                        Before beginning a search engine optimization (SEO) project, it is important to understand the process involved in an effective SEO campaign. Digi Flier caters to clients who require an intensive, full-service approach to search engine marketing.
                    </p>
                </div>
            </div>
            <div class="row">
    ...
    <!-- Packages -->
    <section class="pt-120 pb-55" style="background-color:#e9defd;">
        <div class="container">
            <div class="row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".2">
                        <div class="single-feature-img">
                            <i class="far fa-thumbs-up" style="font-size: 50px;"></i>
                        </div>
                        <div class="single-feature-content">
